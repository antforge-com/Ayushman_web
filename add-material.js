...
function calculatePrices() {
    ...
    // Calculate cost per unit based on purchase quantity
...
async function handleMaterialInputBlur() {
    ...
    if (materialName) {
        ...
        if (latestData) {
            ...
            // Make cost per unit field readonly, but allow stock to be editable
...
// Add event listener for manual stock input to auto-calculate cost per unit
stockInput.addEventListener('input', calculatePrices);
